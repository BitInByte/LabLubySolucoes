const { task1, task2, task3, task4, task5, task6, task7, task8, task9, task10 } = require("./tasks.js");
...
console.log("Task 8: ", task8([1, 2, [3], [4, 5], [4, 5, [2, 5, [4, 5]]]]))
//console.log("Task 8: ", task8('a'))
console.log("Task 9: ", task9([1, 2, 3, 4, 5], 2))
console.log("Task 10: ", task10([6, 8, 10], [8, 9, 10]))
